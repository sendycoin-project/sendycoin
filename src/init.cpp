...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/sendycoin-project/sendycoin>";
    const std::string URL_WEBSITE = "<https://sendycoin.org>";
