...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s sendycoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  sendycoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded sendycoin transaction") + "\n" +
              "  sendycoin-tx [options] -create [commands]   " + _("Create hex-encoded sendycoin transaction") + "\n" +
              "\n";
